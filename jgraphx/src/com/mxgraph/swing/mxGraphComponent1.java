 ...
 */
public class mxGraphComponent1 extends JScrollPane implements Printable
{
	 ...
	 * @param graph
	 */
	public mxGraphComponent1(mxGraph graph)
	{
		canvas = createCanvas();
	...
	public int print(Graphics g, PageFormat printFormat, int page)
	{
		...
		RepaintManager currentManager = RepaintManager
				.currentManager(mxGraphComponent1.this);
	...
	public class mxGraphControl extends JComponent
	{
		 ...
		 * 
		 */
		public mxGraphComponent1 getGraphContainer()
		{
			return mxGraphComponent1.this;
		}
			...
			MouseMotionListener
	{
		 ...
		 * 
		 */
		protected mxGraphComponent1 graphComponent;

		/**
		 * 
		 */
		public mxMouseRedirector(mxGraphComponent1 graphComponent)
		{
