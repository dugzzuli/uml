...
import com.mxgraph.swing.mxGraphComponent1;
...
public class mxInteractiveCanvas extends mxGraphics2DCanvas
{
	...
	public boolean contains(mxGraphComponent1 graphComponent, Rectangle rect,
			mxCellState state)
	{
		return state != null && state.getX() >= rect.x
				&& state.getY() >= rect.y
	...
	public boolean intersects(mxGraphComponent1 graphComponent, Rectangle rect,
			mxCellState state)
	{
		if (state != null)
		{
	...
	public boolean hitSwimlaneContent(mxGraphComponent1 graphComponent,
			mxCellState swimlane, int x, int y)
	{
		if (swimlane != null)
		{
